...
$headerImage = "../Pictures/capital-markets.jpg";
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title><?php echo $pageTitle; ?> - Hekimoglu Attorney Partnership</title>
...
<body>
    ...
    <div class="content-area">
        <div class="content-box">
            ...
            <p>This is a placeholder content for the <?php echo $pageTitle; ?> page.</p>
        </div>
    </div>
